...
## **osu! skin**
###### osu! is a free to play and open source rhythm game available on PC. A skin for this game is basically an overlay for their default UI while retaining the same features and playablity. I used Adobe Photoshop to make the still images and Adobe After Effects to animate some portions about a year or two ago. There are two versions, dark and light, because the light version is blinding to the eyes, but I still kept it, since it goes along with the theme. It is possible to switch between modes by dragging the light mode files and replacing it with the dark mode ones and vice versa all through the game folder.
